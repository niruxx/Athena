...
template <> constexpr inline auto AppSettings::qt_create_metaobjectdata<qt_meta_tag_ZN11AppSettingsE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'compactPackageListsChanged'
...
void AppSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->themeModeChanged((*reinterpret_cast<std::add_pointer_t<ThemeMode>>(_a[1]))); break;
        case 1: _t->compactPackageListsChanged((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AppSettings::*)(ThemeMode )>(_a, &AppSettings::themeModeChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (AppSettings::*)(bool )>(_a, &AppSettings::compactPackageListsChanged, 1))
            return;
    }
}
...
// SIGNAL 0
void AppSettings::themeModeChanged(ThemeMode _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void AppSettings::compactPackageListsChanged(bool _t1)
{
